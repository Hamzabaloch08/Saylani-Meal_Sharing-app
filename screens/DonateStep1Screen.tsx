import { useDonateNavigation } from "@/types/navigation";
...
const DonateStep1Screen = () => {
  const navigation = useDonateNavigation();
        ...
        <View className="px-6 pt-10">
          ...
          <View className="mb-8">
            ...
            <Text className="text-sm font-jakarta text-gray-400 mt-2 leading-6">
              Your contribution helps us match donations with local community
              needs accurately.
            </Text>
          </View>
              ...
              {categories.map((cat) => (
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    width: (width - 64) / 2,
                    shadowColor:
                      selectedCategory === cat.id ? Colors.primary : "#000",
                ...
                >
                  <MaterialCommunityIcons
                    ...
                    size={20}
                    color={
                      selectedCategory === cat.id ? "white" : Colors.primary
                    }
                  />
                  <Text
                    ...
                    style={{
                      color:
                        selectedCategory === cat.id ? "white" : Colors.heading,
                    }}
                  >
                    {cat.label}
                  </Text>
          ...
          <View className="mb-10 bg-white p-8 rounded-[40px] shadow-sm shadow-blue-50 border border-gray-50">
            <View className="flex-row justify-between items-center mb-8">
              ...
              <View className="flex-row items-end">
                ...
                <Text
                  className="text-lg font-jakarta-bold ml-1 mb-1"
                  style={{ color: Colors.primary }}
                >
                  +
                </Text>
            ...
            <View className="flex-row justify-between mt-4">
              <Text className="text-[9px] font-jakarta-bold text-gray-300 uppercase">
                10 Pers
              </Text>
              <Text className="text-[9px] font-jakarta-bold text-gray-300 uppercase">
                50 Pers
          ...
          <View className="mb-6">
            <Text
              className="text-2xl font-jakarta-extrabold mb-6"
              style={{ color: Colors.heading }}
            >
              Scheduling
            </Text>
