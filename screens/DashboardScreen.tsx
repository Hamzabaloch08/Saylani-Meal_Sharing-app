import { useDashboardNavigation } from "@/types/navigation";
        ...
        <View className="px-6 pt-2">
          ...
          <View className="mb-6">
            <View className="flex-row items-center">
              <Text
                className="text-3xl font-jakarta-extrabold"
            ...
            <Text
              className="text-base font-jakarta mt-1"
          ...
          >
            ...
            <View className="flex-row items-center mb-4">
              <View className="bg-white/20 p-2 rounded-lg">
                <Svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                  ...
                  />
                  <Path
                    d="M12 18l-1.5-1.5a10 10 0 0 1-3.5-6.5V9a2 2 0 0 1 4 0v1h2V9a2 2 0 0 1 4 0v1a10 10 0 0 1-3.5 6.5L12 18z"
                    fill="white"
                    opacity="0.3"
                  />
                </Svg>
            ...
            >
              <Text
                className="font-jakarta-bold mr-2"
          ...
          <View className="mt-8 flex-row justify-between mb-8">
            ...
            <View className="bg-white p-6 rounded-[35px] flex-1 mr-4 shadow-sm shadow-blue-50">
              <View className="flex-row items-center mb-4">
                ...
                <Text
                  className="text-[10px] font-jakarta-bold ml-2 uppercase tracking-widest"
              ...
              <Text
                className="text-4xl font-jakarta-extrabold"
                style={{ color: Colors.heading }}
              >
                8,432
              </Text>
          ...
          <View className="flex-row justify-between items-end mb-6 px-1">
            <Text
              className="text-xl font-jakarta-extrabold"
              style={{ color: Colors.heading }}
            >
              Recent Requests
            </Text>
            <TouchableOpacity>
              <Text
                className="text-xs font-jakarta-bold uppercase tracking-widest"
                style={{ color: Colors.primary }}
              >
                View All
              </Text>
              ...
              >
                ...
                >
                  <Text
                    ...
                    className="text-[8px] font-jakarta-bold uppercase"
                  >
                    {item.status}
                  </Text>
                </View>
          ...
          <View className="bg-white p-8 rounded-[35px] border border-white shadow-xl shadow-blue-100">
            <View className="flex-row justify-between items-center mb-4">
              <Text
                className="text-lg font-jakarta-extrabold"
                style={{ color: Colors.heading }}
              >
                Your Impact
              </Text>
              <View className="bg-green-50 px-3 py-1 rounded-full">
                <Text
                  className="text-[10px] font-jakarta-bold"
                  style={{ color: "#10B981" }}
                >
                  +12% this month
                </Text>
            ...
            <Text
              className="font-jakarta text-sm leading-6"
              style={{ color: Colors.text }}
            >
              You've helped feed over{" "}
              <Text
